...
elseif("${TargetType}" STREQUAL "Dev")
  ...
  file(COPY "${BoostSourceDir}/boost" DESTINATION "${InstallerDir}/opt/maidsafe/include/boost/")
  ...
  file(COPY "${SUPER_PROJECT_SOURCE_DIR}/src/third_party_libs/cereal/include/cereal" DESTINATION "${InstallerDir}/opt/maidsafe/include/cereal")
